...
import argparse
import os
from others.my_logging import init_logger
...
def train(path):
    ...
    parser.add_argument("-model_path", default='./presumm_model/')
    parser.add_argument("-result_path", default='./results/cnndm')
    parser.add_argument("-temp_dir", default='./temp')
    parser.add_argument("-text_src", default=str(path))
    ...
    parser.add_argument("-test_from", default='./presumm_model/model_step_148000.pt')
